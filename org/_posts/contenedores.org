...
adecuada a alguna aplicación en particular: [[https://es.cppreference.com/w/cpp/container/stack][~std::stack~]], [[https://es.cppreference.com/w/cpp/container/queue][~std::queue~]]
y [[https://es.cppreference.com/w/cpp/container/priority_queue][~std::priority_queue~]].
