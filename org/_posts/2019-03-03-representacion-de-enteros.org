...
método habitual de la suma aplicada a las tiras de bits, pues $2 + =
...
el bit más significativo de los sumandos (si ambos son 1, hay
overflow, si no, no). En cambio, en la suma con números complemento a
dos esta regla es diferente. Veamos, por ejemplo, la suma $-1 + -1$,
estos es $1111\ 1111 + 1111\ 1111 = 1111\ 1110$ con /carry/. Sin
embargo, aquí no hubo overflow y $1111\ 1110 = -2$ en complemento a
dos. Para que haya overflow en complemento a dos tiene que ocurrir que 
/el carry hacia el bit del signo (el bit más significativo) sea
diferente al carry fuera de la representación/.
